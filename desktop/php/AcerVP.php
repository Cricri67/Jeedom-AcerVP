			...
			<form class="form-horizontal">
				<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="AdrIP" placeholder="192.168.100.10"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">{{Identifiant}}</label>
							<div class="col-sm-3">
								<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="UserId" placeholder="Administrateur"/>
							</div>
						</div>
						<div class="form-group">
...
<?php include_file('desktop', 'AcerVP', 'js', 'AcerVP');?>
